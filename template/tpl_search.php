...
<div class="searchbar">
    ...
    <label>Location</label>
        ...
        <div class="slidecontainer" >
            ...
            <input type="range" min="1" max="100" value="<?=$minPrice?>" class="slider" id="minPrice" oninput="updateSlider('minPrice','valueMin')">
            <p>Value: <span id="valueMin"><?=$minPrice?></span></p>
            <label>Max price</label>
            <input  type="range" min="1" max="100" value="<?=$maxPrice?>" class="slider" id="maxPrice" oninput="updateSlider('maxPrice','valueMax')">
